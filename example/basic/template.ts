...
hr { display: block; height: 1px; background-color: #d1d5db; border: none; }
</style></head>
<body>
	<main class="flex flex-col gap-5 p-4">
		<header class="flex flex-col gap-5">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 103 62" style="width: 64px; height: 38px;">
			...
			<hgroup>
				<h1 class="text-xl">Comprovante de pagamento</h1><small class="text-sm">segunda-feira, 25 de maio de 2026 às 15:29</small>
			</hgroup>
		</header>
		<section class="text-sm">
			<h3 class="font-bold">Valor</h3>
			<p class="text-xl">R$ 250,00</p>
		</section>
		<section class="text-sm">
			<h3 class="font-bold">Tipo de transação</h3>
			<p>Pagamento com saldo Trino</p>
		</section>
		<hr>
		<section class="text-sm">
			<h3 class="font-bold">Destinatário</h3>
			<p>Casa de carne Borges LTDA</p>
			<p><span>CNPJ:</span> 61.067.997/0001-91</p>
		</section>
		<section class="text-sm">
			<h3 class="font-bold">Origem</h3>
			<p>Maria Aparecida Costa</p>
			<p><span>CPF:</span> 987.654.321-00</p>
		</section>
		<hr>
		<section class="text-sm">
			<h3 class="font-bold">ID da transação</h3>
			<p>TRN1779733785846</p>
		</section>
